...
def test_ppc_style_2_misc():
    ...
    assert result == (
        ...
        "\x1b[31;3m\x1b[36m- k_1:\x1b[0m \x1b[36mv_1\x1b[0m\x1b[0m\n"
        "\x1b[31;3m\x1b[36m- k_2:\x1b[0m \x1b[36mv_2\x1b[0m\x1b[0m"
    )
...
def test_ppc_style_3_dict():
    ...
    # print(f"\n{result}\n\n{[result]}")
    assert result == (
        "\x1b[31mef:\x1b[0m\x1b[37;3m Lorem ipsum\x1b[0m\n"
    ...
    # print(f"\n{result}\n\n{[result]}")
    assert result == (
        "\x1b[31m- ab:\x1b[0m \x1b[37;3mxy\x1b[0m\n"
        "\x1b[31m- cd:\x1b[0m \x1b[37;3m34\x1b[0m\n"
        "\x1b[31m- ef:\x1b[0m\x1b[37;3m Lorem\x1b[0m\n"
    ...
    assert result == (
        "\x1b[31m- ab:\x1b[0m \x1b[37;3mxy\x1b[0m\n"
        "\x1b[31m- cd:\x1b[0m \x1b[37;3m[abc, 123]\x1b[0m\n"
        "\x1b[31m- ef:\x1b[0m\n"
        "    - \x1b[37;3mabc\x1b[0m\n"
        "    - \x1b[37;3mdef\x1b[0m\n"
        "    - \x1b[37;3mghi\x1b[0m\n"
    ...
    # print(f"\n{result}\n\n{[result]}")
    assert result == (
        "\x1b[31mab:\x1b[0m \x1b[37;3mA Foo with:\x1b[0m\n"
        "\x1b[37;3m  \x1b[36m- k_1:\x1b[0m \x1b[36mv_1\x1b[0m\x1b[0m\n"
        "\x1b[37;3m  \x1b[36m- k_2:\x1b[0m \x1b[36mv_2\x1b[0m\x1b[0m"
    )
